...
- `PENDING` implies funds have left the customers account and is due to be settled.
- `QUEUED` implies funds have not been released from the customers account as extra checks are being performed by their bank.

...
description: "How to receive webhook notifications for events"
icon: "webhook"
---
...
- IP address for whitelisting (Production): `35.234.155.168`

## How to decrypt webhook notifications

<CodeGroup>
```javascript JavaScript lines icon="square-js"
